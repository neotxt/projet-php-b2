...
<section class="home-banner text-white p-5 text-center shadow-sm">
    <div class="container py-5">
        ...
        <a href="index.php?page=articles" class="btn btn-light btn-lg mt-3">Voir les articles</a>
    </div>
</section>
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="src/public/img/banniere.jpg" class="card-img-top" alt="Vêtement 1">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="src/public/img/banniere.jpg" class="card-img-top" alt="Vêtement 2">
                <div class="card-body text-center">
        ...
        <div class="col-md-4 mb-4">
            <div class="card h-100 shadow-sm">
                <img src="src/public/img/banniere.jpg" class="card-img-top" alt="Vêtement 3">
                <div class="card-body text-center">
